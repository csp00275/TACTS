...
#ifndef AI_FOURLINE_H
#define AI_FOURLINE_H
#pragma once

#include "fourline_config.h"
...
#define AI_FOURLINE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_FOURLINE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_FOURLINE_IN_NUM        (1)

AI_DEPRECATED
#define AI_FOURLINE_IN \
  ai_fourline_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_FOURLINE_IN_SIZE { \
  AI_FOURLINE_IN_1_SIZE, \
}
#define AI_FOURLINE_IN_SIZE_BYTES { \
  AI_FOURLINE_IN_1_SIZE_BYTES, \
}
#define AI_FOURLINE_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_FOURLINE_IN_1_HEIGHT      (4)
#define AI_FOURLINE_IN_1_WIDTH       (13)
#define AI_FOURLINE_IN_1_CHANNEL     (1)
#define AI_FOURLINE_IN_1_SIZE        (4 * 13 * 1)
#define AI_FOURLINE_IN_1_SIZE_BYTES  (208)

/******************************************************************************/
#define AI_FOURLINE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_FOURLINE_OUT \
  ai_fourline_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_FOURLINE_OUT_SIZE { \
  AI_FOURLINE_OUT_1_SIZE, \
}
#define AI_FOURLINE_OUT_SIZE_BYTES { \
  AI_FOURLINE_OUT_1_SIZE_BYTES, \
}
#define AI_FOURLINE_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_FOURLINE_OUT_1_CHANNEL     (4)
#define AI_FOURLINE_OUT_1_SIZE        (4)
#define AI_FOURLINE_OUT_1_SIZE_BYTES  (16)

/******************************************************************************/
#define AI_FOURLINE_N_NODES (13)
 ...
 * @ref ai_fourline_create. Both the activations memory buffer 
 ...
 * using @ref ai_fourline_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_fourline_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_fourline_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_FOURLINE_*
 * defines into file @ref fourline.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
